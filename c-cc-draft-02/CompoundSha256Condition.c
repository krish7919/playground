...
static ber_tlv_tag_t asn_DEF_cost_tags_3[] = {
...
static ber_tlv_tag_t asn_DEF_CompoundSha256Condition_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CompoundSha256Condition_tag2el_1[] = {
