...
static asn_INTEGER_specifics_t asn_SPC_maxMessageLength_specs_3 = {
	0,	0,	0,	0,	0,
	0,	/* Native long size */
	1	/* Unsigned representation */
};
static ber_tlv_tag_t asn_DEF_maxMessageLength_tags_3[] = {
...
static ber_tlv_tag_t asn_DEF_PrefixFingerprintContents_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PrefixFingerprintContents_tag2el_1[] = {
