...
static ber_tlv_tag_t asn_DEF_subconditions_tags_3[] = {
...
static ber_tlv_tag_t asn_DEF_ThresholdFingerprintContents_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ThresholdFingerprintContents_tag2el_1[] = {
